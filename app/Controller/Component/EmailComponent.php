...
{ 
   ...
   */ 
    var $from = 'contato@biodinamic.com.br'; 
    var $fromName = "Cake PHP-Mailer"; 
    var $smtpUserName = 'smtp.biodinamic.com.br';  // SMTP username 
    var $smtpPassword = 'contato@biodinamic.com.br'; // SMTP password 
    var $smtpHostNames = "bio2456";  // specify main and backup server 
    var $text_body = null; 
    var $html_body = null; 
    var $to = 'gustavostrassburger@outlook.com'; 
    var $toName = 'BioDinamic'; 
    var $subject = 'Teste'; 
    var $cc = null; 
    var $bcc = null; 
